...
PROJECT := testSTM32F407VE_BLACK_ETH
...
OBJECTS += ./custom_targets/TARGET_STM/TARGET_STM32F4/TARGET_STM32F407xE/TARGET_STM32F407VE_BLACK/USBPhy_STM32F407VE.o
OBJECTS += ./custom_targets/TARGET_STM/TARGET_STM32F4/TARGET_STM32F407xE/TARGET_STM32F407VE_BLACK/stm32f4_eth_conf.o
OBJECTS += ./custom_targets/TARGET_STM/TARGET_STM32F4/TARGET_STM32F407xE/TARGET_STM32F407VE_BLACK/stm32f4_eth_init.o
...
OBJECTS += ./libs/MQTTClient/MQTTThreadedClient.o
...
OBJECTS += ./libs/WebSocketClient/Websocket.o
OBJECTS += ./libs/WebSocketServer/WebSocketConnection.o
OBJECTS += ./libs/WebSocketServer/WebSocketServer.o
OBJECTS += ./libs/WebSocketServer/sha1_ws.o
...
OBJECTS += ./source/http_server.o
OBJECTS += ./source/main.o
OBJECTS += ./source/threadIO.o
OBJECTS += ./source/threadWebSocketServer.o
...
INCLUDE_PATHS += -I.././libs/MQTTClient
INCLUDE_PATHS += -I.././libs/MQTTPacket
INCLUDE_PATHS += -I.././libs/TextLCD
INCLUDE_PATHS += -I.././libs/WebSocketClient
INCLUDE_PATHS += -I.././libs/WebSocketServer
...
INCLUDE_PATHS += -I../D:/Projects/Sn/LocalGit/test/testSTM32F407VE_BLACK_ETH/mbed-os
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1575570963.3
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1575570963.3
...
ASM_FLAGS += -I..\libs\MQTTClient
ASM_FLAGS += -I..\libs\MQTTPacket
ASM_FLAGS += -I..\libs\TextLCD
ASM_FLAGS += -I..\libs\WebSocketClient
ASM_FLAGS += -I..\libs\WebSocketServer
...
ASM_FLAGS += -I..\source
ASM_FLAGS += -ID:\Projects\Sn\LocalGit\test\testSTM32F407VE_BLACK_ETH\mbed-os
ASM_FLAGS += -include
