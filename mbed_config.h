...
#define MBED_CONF_LWIP_SOCKET_MAX                                             10                                                                                               // set by application[*]
...
#define MBED_CONF_LWIP_TCP_SOCKET_MAX                                         10                                                                                               // set by application[*]
...
#define MBED_CONF_NSAPI_SOCKET_STATS_ENABLED                                  1                                                                                                // set by application[*]
#define MBED_CONF_NSAPI_SOCKET_STATS_MAX_COUNT                                30                                                                                               // set by application[*]
...
#define MBED_CONF_TARGET_NETWORK_DEFAULT_INTERFACE_TYPE                       ETHERNET                                                                                         // set by target:STM32F407VE_BLACK
